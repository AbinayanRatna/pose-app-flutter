...
import 'detector_view_vip.dart';

class PoseDetectorViewVip extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PoseDetectorViewVipState();
}

class _PoseDetectorViewVipState extends State<PoseDetectorViewVip> {
